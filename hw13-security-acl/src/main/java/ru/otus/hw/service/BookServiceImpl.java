...
public class BookServiceImpl implements BookService {
  ...
  public BookDto create(BookForm form) {
    ...
    aclService.createPermission(savedBook, BasePermission.READ, BasePermission.WRITE,
      BasePermission.DELETE);
    return bookMapper.toDto(savedBook);
  }

  @PreAuthorize("hasPermission(#id, 'ru.otus.hw.model.Book', 'WRITE')")
  @Override
  @Transactional
  ...
  public void deleteById(long id) {
    Book book = findBook(id);
    aclService.deletePermissions(id, Book.class);
