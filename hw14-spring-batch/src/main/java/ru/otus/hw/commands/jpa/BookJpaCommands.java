...
import ru.otus.hw.converters.jpa.BookJpaConverter;
import ru.otus.hw.services.jpa.BookJpaService;
...
@ShellComponent
public class BookJpaCommands {

  private final BookJpaService bookService;

  private final BookJpaConverter bookConverter;
