...
import ru.otus.hw.services.jpa.BookJpaServiceImpl;

@DisplayName("Сервис для работы с книгами")
@DataJpaTest
@Import(BookJpaServiceImpl.class)
public class BookJpaServiceImplTest {

  @Autowired
  private BookJpaServiceImpl bookService;
